...
const TEXTAREA_CLASS =
  "flex w-full rounded-lg border border-input bg-background px-3 py-2 text-base leading-relaxed outline-none transition-colors focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/30 disabled:cursor-not-allowed disabled:opacity-50";
